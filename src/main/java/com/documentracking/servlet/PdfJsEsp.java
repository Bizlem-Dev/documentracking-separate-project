...
@Properties({ @Property(name = "service.description", value = "Prefix Test Servlet Minus One"),
		...
		@Property(name = "sling.servlet.paths", value = { "/servlet/service/PdfJs" }),
...
public class PdfJsEsp extends SlingAllMethodsServlet {
		...
		PrintWriter out=response.getWriter();
	       ...
	       try {
	  		...
	  		try {
	  			...
	  			RequestDispatcher dis= request.getRequestDispatcher("/content/static/.PdfJs");
