...
@Properties({ @Property(name = "service.description", value = "Prefix Test Servlet Minus One"),
		...
		@Property(name = "sling.servlet.paths", value = { "/servlet/service/DocumentTracking" }),
...
public class DocumenTrackingEsp extends SlingAllMethodsServlet {
		...
		PrintWriter out=response.getWriter();
	       ...
	       try {
	  		...
	  		try {
	  			...
	  			RequestDispatcher dis= request.getRequestDispatcher("/content/static/.DocumentTracking");
